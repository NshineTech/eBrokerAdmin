            ...
            <div class="row">
                <div class="col-12">
                    <table class="table table-borderless" aria-describedby="mydesc" class='table-striped'
                        id="table_list" data-toggle="table" data-url="{{ url('userList') }}" data-click-to-select="true"
                        ...
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" data-field="status" data-sortable="false" data-align="center">Active
                                    Status</th>
                                <th scope="col" data-field="operate" data-sortable="false" data-events="actionEvents"
                                ...
                                <table id="table" class="table permission-table" aria-describedby="mydesc">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @for ($i = 0; $i < count($actions); $i++) @php
                                                $index=array_search($actions[$i], $value); @endphp @if ($index !==false)
                                                <td>
                                                <div class="form-check">
                                                    <input
