                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-2 col-12 form-group mandatory">
                            ...
                            'data-parsley-required' => 'true', 'id' => 'name']) }}
                        ...
                        <div class="col-md-2 col-12 form-group mandatory">
                            ...
                            (in days)', 'data-parsley-required' => 'true','id' => 'duration', 'min' => '1']) }}
                        ...
                        <div class="col-md-2 col-12 form-group mandatory">
                            ...
                            col-12 ']) }}
                            {{ Form::number('price', '', ['class' => 'form-control ', 'placeholder' => 'Package Price',
                            'data-parsley-required' => 'true', 'id' => 'price', 'min' => '0']) }}
                        ...
                        <div id="limitation_for_property" class="col-md-1 col-sm-12 form-group">
                            ...
                            {{ Form::number('property_limit', '', ['class' => 'form-control', 'type' => 'number', 'min'
                            =>
                            '1', 'placeholder' => 'limitation', 'id' => 'propertylimit', 'min' => '1']) }}
                        ...
                        <div id="limitation_for_advertisement" class="col-md-1 col-sm-12 form-group">
                            ...
                            {{ Form::number('advertisement_limit', '', ['class' => 'form-control ', 'type' => 'number',
                            'min' =>
                            '1', 'placeholder' => 'limitation ', 'id' => 'advertisementlimit', 'min' => '1']) }}
                                ...
                                <table class="table table-borderless" aria-describedby="mydesc" class='table-striped'
                                    ...
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th scope="col" data-field="status" data-align="center"
                                                data-sortable="false">
                                                {{ __('Status') }}
                                            </th>
                        ...
                        <form action="{{ url('package-update') }}" class="form-horizontal" enctype="multipart/form-data"
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group ">
                                            <label for="edit_duration" class="form-label col-12 ">{{ __('Duration')
                                                }}</label>
                            ...
                            <div class="row">
                                ...
                                {{-- <div id="property_limitation" class="col-md-12 col-6"> --}}
                                    {{ Form::label('price', __('Property'), ['class' => 'form-label col-sm-12
                                    col-md-12']) }}
                                    ...
                                    <div class="col-sm-12 col-md-12" id="limitation_for_property">
                                        <div class="form-group">
                                            {{-- {{ Form::label('limitation', 'limitation for edit property', ['class'
                                            => 'form-label col-12 ']) }} --}}
                                            {{ Form::number('property_limit', '', ['class' => 'form-control ',
                                            'placeholder' => 'limitation', 'id' => 'property_limit','min'=>0]) }}
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    {{ Form::label('price', __('Advertisement'), ['class' => 'form-label col-sm-12
                                    col-md-12 ']) }}
                                    ...
                                    <div class="col-sm-12 col-md-6 form-group " id="limitation_for_advertisement">
                                        ...
                                        {{ Form::number('advertisement_limit', '', ['class' => 'form-control ',
                                        'placeholder' => 'limitation ', 'id' => 'advertisement_limit','min'=>0]) }}
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">{{ __('Save')
                                    }}</button>
                        </form>
                    </div>
                </div>
