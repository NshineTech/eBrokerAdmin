            ...
            <div class="card-body">
                ...
                <div class="row mt-1">
                    ...
                    <div class="form-group mandatory row">
                        {{ Form::label('image', __('Image'), ['class' => 'col-md-1 col-sm-12 col-form-label
                        text-center']) }}
                        <div class="col-md-3 col-sm-12">
                            {{ Form::file('image[]', ['class' => 'form-control', 'multiple' => true, 'accept' =>
                            'image/*']) }}
                            @if (count($errors) > 0)
                        ...
                        {{ Form::label('category', __('Category'), ['class' => 'col-md-1 col-sm-12 col-form-label
                        text-center']) }}
                        <div class="col-md-3 col-sm-12">
                        ...
                        {{ Form::label('property', __('Property'), ['class' => 'col-md-1 col-sm-12 col-form-label
                        text-center']) }}
                        <div class="col-md-3 col-sm-12">
