...
Route::middleware(['auth', 'checklogin'])->group(function () {
    Route::group(['middleware' => 'language'], function () {
        ...
        Route::get('downloadWebFile', [LanguageController::class, 'downloadWebFile'])->name('downloadWebFile');
        ...
        Route::post('article_list', [ArticleController::class, 'show'])->name('article_list');
